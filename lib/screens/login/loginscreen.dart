          ...
          Card(
            ...
            child: Container(
              ...
              child:Column(
                children: [
                  SizedBox(height: 20,),
                  UiHelper.CustomText(text: "Nishi", color: Color(0XFF000000), fontweight: FontWeight.w500, fontsize: 14),
                  SizedBox(height: 5,),
                  UiHelper.CustomText(text: "8810XXXX", color: Color(0XFF9C9C9C), fontweight: FontWeight.bold, fontsize: 14, fontfamily: "bold"),
                  SizedBox(height: 20,),
                  ...
                  SizedBox(height: 8,),
                  UiHelper.CustomText(text: "Access your saved address from Zomato automatically", color: Color(0XFF9C9C9C), fontweight: FontWeight.normal, fontsize: 10),
                  SizedBox(height: 15,),
